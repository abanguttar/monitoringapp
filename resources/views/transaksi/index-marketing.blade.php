                ...
                <div class="w-full mt-5 lg:px-8">
                    <div class="min-h-96 overflow-auto">
                        <form action="">
                            ...
                            <div class="ml-2 mt-3">
                                <button type="button" class="btn btn-success btn-outline btn-sm" data-tipe="marketing"
                                ...
                                <a href="{{ URL::current() }}" class="btn btn-neutral bg-black btn-sm">Reset</a>
                            </div>

                        </form>
                        {{-- Hanya menampilkan data yang dicari --}}
                        <table class="table mt-5">
                            ...
                            <tbody>
                                ...
                                @foreach ($transactions as $key => $t)
                                    <tr class="text-black table-row" data-id="/list-peserta/{{ $t->id }}">
                                        <td>{{ $p + ++$key }}</td>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '#btn-export', function() {
                ...
                window.location.href = `/export-marketing?${fullUrl['query']}`
            })
